...
module Fake_http = struct
  ...
  let next_response_body =
    ref
      "{\"id\":\"chatcmpl_xai\",\"object\":\"chat.completion\",\"model\":\"grok-4-1-fast-non-reasoning\",\"choices\":[{\"index\":0,\"message\":{\"role\":\"assistant\",\"content\":\"Hello from Grok\",\"reasoning_content\":\"short reasoning\"},\"finish_reason\":\"stop\"}],\"usage\":{\"prompt_tokens\":9,\"completion_tokens\":4,\"total_tokens\":13,\"cost_in_usd_ticks\":2500000000}}"
...
module Provider = Chatoyant.Provider.Xai.Make_provider (Fake_http) (struct
    ...
    [
      ...
      ( "properties",
        Chatoyant.Runtime.Json.Object
          [
            ( "answer",
              Chatoyant.Runtime.Json.Object [ ("type", Chatoyant.Runtime.Json.String "string") ] );
          ] );
      ( "required",
                  ...
                  ( "message",
                    Chatoyant.Runtime.Json.Object
                      [
                        ...
                        ("reasoning_content", Chatoyant.Runtime.Json.String "Why");
                      ] );
...
let test_responses_api () =
  let body =
    responses_fixture ()
    |> Chatoyant.Provider.Xai.responses_request_json
    |> Chatoyant.Runtime.Json.to_string
  in
                      ...
                      [
                        Chatoyant.Runtime.Json.Object
                          [
                            ...
                            ("text", Chatoyant.Runtime.Json.String "Hello from Responses");
                          ];
                      ] );
                ];
              Chatoyant.Runtime.Json.Object
                  ...
                  ( "summary",
                    Chatoyant.Runtime.Json.Array
                      [
                        Chatoyant.Runtime.Json.Object
                          [
                            ("type", Chatoyant.Runtime.Json.String "summary_text");
                            ("text", Chatoyant.Runtime.Json.String "Reasoning summary");
                          ];
                      ] );
                ];
            ] );
  ...
  let response =
    Chatoyant.Provider.Xai.stream_response_of_chunks
      [
        ...
        "data: {\"choices\":[{\"delta\":{\"content\":\"lo\",\"reasoning_content\":\"cause\"}}]}\n\n";
        "data: {\"choices\":[{\"finish_reason\":\"stop\",\"delta\":{}}],\"usage\":{\"prompt_tokens\":2,\"completion_tokens\":1,\"total_tokens\":3,\"cost_in_usd_ticks\":1000000000}}\n\n";
        "data: [DONE]\n\n";
      ]
  in
  match response with
    ...
    Chatoyant.Provider.Xai.
      {
        ...
        edit_images =
          [
            { source_url = "https://example.com/a.png"; source_type = "image_url" };
            { source_url = "https://example.com/b.png"; source_type = "image_url" };
          ];
        edit_n = Some 1;
...
let test_image_and_video_response_decode () =
        ...
        ( "data",
          Chatoyant.Runtime.Json.Array
            [
              Chatoyant.Runtime.Json.Object
                [
                  ("url", Chatoyant.Runtime.Json.String "https://example.com/image.png");
                  ("revised_prompt", Chatoyant.Runtime.Json.String "A revised prompt");
                ];
            ] );
      ]
  in
  ...
  let video_start =
    Chatoyant.Provider.Xai.video_start_response_of_json
      (Chatoyant.Runtime.Json.Object [ ("request_id", Chatoyant.Runtime.Json.String "vid_123") ])
  in
      ...
      (Chatoyant.Runtime.Json.Object
         [
           ...
           ( "video",
             Chatoyant.Runtime.Json.Object
               [
                 ("url", Chatoyant.Runtime.Json.String "https://example.com/video.mp4");
                 ("duration", Chatoyant.Runtime.Json.Float 6.0);
                 ("model", Chatoyant.Runtime.Json.String "grok-imagine-video-1.5");
               ] );
         ])
  in
    ...
    Chatoyant.Provider.Xai.batch_of_json
      (Chatoyant.Runtime.Json.Object
         [
           ...
           ("state", Chatoyant.Runtime.Json.Object [ ("succeeded", Chatoyant.Runtime.Json.Float 1.0) ]);
         ])
  in
    ...
    Chatoyant.Provider.Xai.batch_list_of_json
      (Chatoyant.Runtime.Json.Object
         [
           ( "batches",
             Chatoyant.Runtime.Json.Array
               [ Chatoyant.Runtime.Json.Object [ ("batch_id", Chatoyant.Runtime.Json.String "batch_123") ] ] );
      ...
      (Chatoyant.Runtime.Json.Object
         [
           ( "batch_request_metadata",
             Chatoyant.Runtime.Json.Array
               [ Chatoyant.Runtime.Json.Object [ ("request_id", Chatoyant.Runtime.Json.String "req_123") ] ] );
         ])
  in
...
let test_client_and_provider () =
  ...
  | Some request ->
      ...
      if not (List.mem ("Authorization", "Bearer test-key") request.headers) then
        failwith "missing authorization header");
  Fake_http.next_response_status := 400;
  Fake_http.next_response_body := "{\"error\":{\"type\":\"invalid_request\",\"message\":\"bad xai request\"}}";
  (match Client.create_chat config (request_fixture ()) with
...
let test_client_batches () =
  ...
  Fake_http.next_response_status := 200;
  Fake_http.next_response_body :=
    "{\"batch_id\":\"batch_123\",\"create_api_key_id\":\"key_123\",\"create_time\":\"2026-01-01T00:00:00Z\",\"name\":\"nightly evals\",\"state\":{\"processing\":0}}";
  ...
  (match
   ...
   with
  | Error error -> failwith error.error_message
  | Ok metadata -> assert_equal_int 1 (List.length metadata.batch_request_metadata));
  Fake_http.next_response_body :=
...
let test_client_responses_and_models () =
  ...
  Fake_http.next_response_status := 200;
  Fake_http.next_response_body :=
    "{\"id\":\"resp_123\",\"object\":\"response\",\"model\":\"grok-4.20-0309-reasoning\",\"status\":\"completed\",\"output\":[{\"type\":\"message\",\"content\":[{\"type\":\"output_text\",\"text\":\"Hello from Responses\"}]}],\"usage\":{\"input_tokens\":1,\"output_tokens\":2,\"total_tokens\":3}}";
    ...
    Chatoyant.Provider.Xai.
      {
        ...
        collection_index_configuration =
          Some (Chatoyant.Runtime.Json.Object [ ("chunk_size", Chatoyant.Runtime.Json.Float 800.0) ]);
...
let test_client_files_and_downloads () =
  ...
  | Some request ->
      ...
      if List.exists (fun (name, _) -> String.lowercase_ascii name = "content-type") request.headers then
        failwith "multipart xAI file upload should not force content-type";
  ...
  (match Client.list_files ~limit:10 ~order:"desc" ~sort_by:"created_at" config with
  | Error error -> failwith error.error_message
...
let test_client_collections () =
  ...
  Fake_http.next_response_status := 200;
  Fake_http.next_response_body :=
    "{\"collection_id\":\"collection_123\",\"collection_name\":\"SEC Filings\",\"collection_description\":\"Reports\",\"documents_count\":0,\"created_at\":\"2026-06-20T00:00:00Z\"}";
  (match
   ...
   with
  | Error error -> failwith error.error_message
  | Ok collection -> assert_equal_string "collection_123" (Option.get collection.collection_id));
  (match !(Fake_http.last_request) with
  | Some request ->
      assert_contains "management-api.x.ai/v1/collections" request.url;
      if not (List.mem ("Authorization", "Bearer management-key") request.headers) then
        failwith "missing xAI management authorization"
  | None -> failwith "expected create collection request");
  Fake_http.next_response_body :=
    "{\"collections\":[{\"collection_id\":\"collection_123\",\"collection_name\":\"SEC Filings\"}],\"pagination_token\":\"next\"}";
  (match Client.list_collections ~limit:10 ~filter:"collection_name:SEC" management with
  | Error error -> failwith error.error_message
  ...
  (match
     Client.add_collection_document management ~collection_id:"collection_123" ~file_id:"file_123"
       ~fields:(Some (Chatoyant.Runtime.Json.Object [ ("ticker", Chatoyant.Runtime.Json.String "TSLA") ]))
   with
  | Error error -> failwith error.error_message
  | Ok document ->
      assert_equal_string "DOCUMENT_STATUS_PROCESSING" (Option.get document.document_status));
  (match !(Fake_http.last_request) with
  | Some request -> assert_contains "/collections/collection_123/documents/file_123" request.url
  ...
  (match Client.list_collection_documents management ~collection_id:"collection_123" with
  | Error error -> failwith error.error_message
  | Ok documents -> assert_equal_int 1 (List.length documents.collection_documents));
  Fake_http.next_response_body := "{\"results\":[{\"file_id\":\"file_123\",\"score\":0.9}]}";
  match
  ...
  with
  | Error error -> failwith error.error_message
  | Ok response -> assert_equal_int 1 (List.length response.collection_search_results)
