...
// gastrorocket: simple genText(prompt, { system, model }) shape.
...
// cosmolytic/micely/orbit: fluent multi-message Chat state, JSON roundtrip, fork.
...
// ghostpaw: Message class shape and tool-call persistence fields.
...
// ghostpaw/orbit: createTool with raw object params and JS callback execution.
...
// ghostpaw: stream() async iterator shape with provider SSE chunks.
globalThis.fetch = async (_url, init) => {
  const body = JSON.parse(init.body);
