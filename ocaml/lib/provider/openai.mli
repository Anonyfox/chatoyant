...
(** Chat Completions request body. [chat_extra] preserves forward
    compatibility for new request fields. *)
...
val transcription_request_json : transcription_request -> Chatoyant_runtime.Json.t
...
val vector_store_file_request_json : vector_store_file_request -> Chatoyant_runtime.Json.t
...
val vector_store_delete_of_json : Chatoyant_runtime.Json.t -> vector_store_delete
val vector_store_file_of_json : Chatoyant_runtime.Json.t -> vector_store_file
val vector_store_file_list_of_json : Chatoyant_runtime.Json.t -> vector_store_file_list
...
val fine_tuning_job_list_of_json : Chatoyant_runtime.Json.t -> fine_tuning_job_list
val fine_tuning_event_list_of_json : Chatoyant_runtime.Json.t -> fine_tuning_event_list
...
module Make_client (Http : Chatoyant_runtime.Effect.HTTP) : sig
  ...
  val create_embedding : config -> embedding_request -> (embedding_response, api_error) result
  val create_transcription :
    config -> transcription_request -> (transcription, api_error) result
  val create_translation : config -> translation_request -> (transcription, api_error) result
  ...
  val create_moderation : config -> moderation_request -> (moderation_response, api_error) result
  ...
  val create_vector_store : config -> vector_store_request -> (vector_store, api_error) result
  val list_vector_stores : config -> (vector_store_list, api_error) result
  val retrieve_vector_store : config -> vector_store_id:string -> (vector_store, api_error) result
  val update_vector_store :
    config -> vector_store_id:string -> vector_store_update -> (vector_store, api_error) result
  ...
  val list_vector_store_files :
    config -> vector_store_id:string -> (vector_store_file_list, api_error) result
  val retrieve_vector_store_file :
    config -> vector_store_id:string -> file_id:string -> (vector_store_file, api_error) result
  val delete_vector_store_file :
    config -> vector_store_id:string -> file_id:string -> (vector_store_delete, api_error) result
