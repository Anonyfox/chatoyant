...
val boolean : ?description:string -> ?optional:bool -> ?default:bool -> unit -> field
val null : ?description:string -> ?optional:bool -> unit -> field
val array : ?description:string -> ?optional:bool -> field -> field
val object_ : ?description:string -> ?optional:bool -> (string * field) list -> field
val enum : ?description:string -> ?optional:bool -> Chatoyant_runtime.Json.t list -> field
val literal : ?description:string -> ?optional:bool -> Chatoyant_runtime.Json.t -> field
...
val with_number_constraints :
  ?minimum:float -> ?maximum:float -> field -> field
