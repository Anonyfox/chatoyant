...
module Make
  ...
  val generate_with_result :
    ?options:Options.t -> t -> (Result.generation, Chatoyant_provider.Provider.error) result
  val generate : ?options:Options.t -> t -> (string, Chatoyant_provider.Provider.error) result
