...
module Args : sig
  ...
  val field :
    string -> Chatoyant_runtime.Json.t -> (Chatoyant_runtime.Json.t, string) Stdlib.result
  val string : string -> Chatoyant_runtime.Json.t -> (string, string) Stdlib.result
  val float : string -> Chatoyant_runtime.Json.t -> (float, string) Stdlib.result
  ...
  val list :
    string -> Chatoyant_runtime.Json.t -> (Chatoyant_runtime.Json.t list, string) Stdlib.result
...
module Json : sig
  ...
  val object_ : (string * Chatoyant_runtime.Json.t) list -> Chatoyant_runtime.Json.t
