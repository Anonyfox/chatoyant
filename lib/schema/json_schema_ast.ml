...
type t = Bool of bool | Object of (string * Json.t) list
...
let of_json = function
  ...
  | _ ->
      Error { path = ""; message = "JSON Schema must be a boolean or object" }
...
let fields = function Bool _ -> None | Object fields -> Some fields
